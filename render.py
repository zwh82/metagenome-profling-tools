...
def fmt_processors(procs: Iterable[Profilers]) -> List[Profilers]:
    """Format a list of profilers so that:
    ...
    # task = ""
    # first = True
    fmt_procs = sorted(procs, key=lambda x: (x.sequence_type, x.name))
